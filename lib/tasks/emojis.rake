...
namespace :emojis do
  ...
  task :generate do
    ...
    codes  = []
    dest   = Rails.root.join('app', 'javascript', 'flavours', 'aether', 'features', 'emoji', 'emoji_map.json')
  ...
  task :generate_borders do
    src = Rails.root.join('app', 'javascript', 'flavours', 'aether', 'features', 'emoji', 'emoji_map.json')
