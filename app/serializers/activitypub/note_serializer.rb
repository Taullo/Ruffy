...
class ActivityPub::NoteSerializer < ActivityPub::Serializer
  ...
  def summary
    object.spoiler_text.presence || (instance_options[:allow_local_only] ? nil : Setting.outgoing_spoilers.presence) || Setting.outgoing_sensitive?
  end
  ...
  def sensitive
    object.account.sensitized? || object.sensitive || (!instance_options[:allow_local_only] && Setting.outgoing_spoilers.present?) || Setting.outgoing_sensitive?
  end
