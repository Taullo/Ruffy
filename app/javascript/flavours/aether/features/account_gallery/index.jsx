...
class AccountGallery extends ImmutablePureComponent {
  ...
  render () {
    const { attachments, isLoading, hasMore, isAccount, multiColumn, suspended, cwVisibility } = this.props;
    ...
    return (
      <Column ref={this.setColumnRef}>
        <MediaColumnHeader onClick={this.handleHeaderClick} multiColumn={multiColumn} />
