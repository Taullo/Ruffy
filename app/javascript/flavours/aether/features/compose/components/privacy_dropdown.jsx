...
const messages = defineMessages({
  ...
  unlisted_long: { id: 'privacy.unlisted.long', defaultMessage: 'Visible for all, but opted-out of explore features' },
  ...
  local_only_long: {
    defaultMessage: 'Prevents post from appearing on other servers',
