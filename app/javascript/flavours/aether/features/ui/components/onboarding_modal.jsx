...
import ComposeForm from 'flavours/aether/features/compose/components/compose_form';
import DrawerAccount from 'flavours/aether/features/compose/components/navigation_bar';
import Search from 'flavours/aether/features/compose/components/search';
import { me, source_url } from 'flavours/aether/initial_state';
...
const PageOne = ({ acct, domain }) => (
  <div className='onboarding-modal__page onboarding-modal__page-one'>
    ...
    <div>
      ...
      <p><FormattedMessage id='onboarding.page_one.federation' defaultMessage='{domain} is a server connected to the Fediverse. The Fediverse is a network of independent servers joining up to make one larger social network. We call these servers instances.' values={{ domain }} /></p>
    ...
    <div className='onboarding-modal__page onboarding-modal__page-six'>
      ...
      <p>
        <FormattedMessage
          ...
          defaultMessage='{domain} runs on Ruffy. Ruffy is a friendly {fork} of {Mastodon}. Ruffy is fully compatible with all Mastodon apps and instances. Ruffy is free open-source software. You can report bugs, request features, or contribute to the code on {github}.'
          values={{
            domain,
