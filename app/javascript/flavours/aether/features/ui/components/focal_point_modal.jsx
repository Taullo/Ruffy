...
import { GIFV } from 'flavours/aether/components/gifv';
import { IconButton } from 'flavours/aether/components/icon_button';
import Audio from 'flavours/aether/features/audio';
import CharacterCounter from 'flavours/aether/features/compose/components/character_counter';
import UploadProgress from 'flavours/aether/features/compose/components/upload_progress';
import { Tesseract as fetchTesseract } from 'flavours/aether/features/ui/util/async-components';
import Video, { getPointerPosition } from 'flavours/aether/features/video';
        ...
        <div className='report-modal__container'>
          <div className='report-modal__comment'>
            ...
            <div className='setting-text__toolbar'>
              ...
              <CharacterCounter max={5000} text={detecting ? '' : description} />
            </div>

            <Button disabled={!dirty || detecting || isUploadingThumbnail || length(description) > 5000 || is_changing_upload} text={intl.formatMessage(is_changing_upload ? messages.applying : messages.apply)} onClick={this.handleSubmit} />
          </div>
