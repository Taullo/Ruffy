...
import { tenorSet, uploadCompose } from 'flavours/aether/actions/compose';
      ...
      <div className='modal-root__modal tenor-modal'>
        <div className='tenor-modal__container'>
          ...
          <div className='modal_bottom'>
            <Button title={intl.formatMessage(messages.cancel)} icon='close' size='16' onClick={this.props.onClose} >{intl.formatMessage(messages.cancel)}</Button>
            <div className='modal_logo'>Powered by <img src='/tenor.svg' alt='Tenor logo' /></div>
          </div>
        </div>
      </div>
    );
