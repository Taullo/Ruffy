...
import { uploadCompose, resetCompose, changeComposeSpoilerness } from 'flavours/aether/actions/compose';
import { expandHomeTimeline } from 'flavours/aether/actions/timelines';
import { expandNotifications, notificationsSetVisibility } from 'flavours/aether/actions/notifications';
import { fetchServer, fetchServerTranslationLanguages } from 'flavours/aether/actions/server';
import { clearHeight } from 'flavours/aether/actions/height_cache';
import { changeLayout } from 'flavours/aether/actions/app';
import { synchronouslySubmitMarkers, submitMarkers, fetchMarkers } from 'flavours/aether/actions/markers';
...
import { closeOnboarding, INTRODUCTION_VERSION } from 'flavours/aether/actions/onboarding';
...
class SwitchingColumnsArea extends React.PureComponent {
  ...
  render () {
    ...
    } else if (timelinePreview && trendsAsLanding) {
      redirect = <Redirect from='/' to='/explore/local' exact />;
    } else {
    ...
    return (
      <ColumnsAreaContainer ref={this.setRef} singleColumn={mobile} navbarUnder={navbarUnder}>
        <WrappedSwitch>
          ...
          <WrappedRoute path={['/explore/federated', '/public', '/timelines/public']} exact component={PublicTimeline} content={children} />
          <WrappedRoute path={['/explore/local', '/explore', '/public/local', '/timelines/public/local']} exact component={CommunityTimeline} content={children} />
          ...
          <WrappedRoute path={['/explore/posts', '/explore/tags', '/explore/suggestions']} component={Explore} content={children} />
