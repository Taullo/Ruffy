...
import api, { getLinks } from 'flavours/aether/api';
import { compareId } from 'flavours/aether/compare_id';
import { usePendingItems as preferPendingItems } from 'flavours/aether/initial_state';
import { toServerSideType } from 'flavours/aether/utils/filters';
...
export const expandTrendingTimeline        = ({ maxId } = {}, done = noOp) => expandTimeline('trending', '/api/v1/trends/statuses', { max_id: maxId }, done);
...
export const expandAccountMediaTimeline    = (accountId, { maxId } = {}) => expandTimeline(`account:${accountId}:media`, `/api/v1/accounts/${accountId}/statuses`, { exclude_replies: true, max_id: maxId, only_media: true, limit: 30 });
...
export const fillTrendingTimelineGaps  = (done = noOp) => fillTimelineGaps('trending', '/api/v1/trends/statuses', {}, done);
